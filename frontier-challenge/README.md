...
Built for the micro1 Frontier Engineering Challenge 2026. Full problem framing: [problem.md](problem.md). Reproduction guide: [REPRODUCTION.md](REPRODUCTION.md). Iteration history: [CHANGELOG.md](CHANGELOG.md). Demo video shooting script: [VIDEO_SCRIPT.md](VIDEO_SCRIPT.md).
